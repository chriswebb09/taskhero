...
struct Constants {
    ...
    static let loginTextFieldHeight = CGFloat(0.07)
    static let loginTextFieldWidth = CGFloat(0.75)
    static let searchTextFieldHeight = CGFloat(0.07)
    static let searchTextFieldWidth = CGFloat(0.75)
